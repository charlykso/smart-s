...
const StudentStatsCards: React.FC<StudentStatsCardsProps> = ({ stats, isLoading }) => {
  ...
  const statCards = [
    ...
    },
    {
      ...
      percentage: ((stats.maleStudents / stats.totalStudents) * 100).toFixed(1),
    },
    {
      ...
      color: 'text-pink-600',
      bgColor: 'bg-pink-50',
      percentage: ((stats.femaleStudents / stats.totalStudents) * 100).toFixed(1),
    },
    {
      title: 'Day Students',
      value: stats.dayStudents,
      icon: CalendarIcon,
      color: 'text-yellow-600',
      bgColor: 'bg-yellow-50',
      percentage: ((stats.dayStudents / stats.totalStudents) * 100).toFixed(1),
    },
    {
      title: 'Boarding Students',
      value: stats.boardingStudents,
      icon: AcademicCapIcon,
      color: 'text-purple-600',
      bgColor: 'bg-purple-50',
      percentage: ((stats.boardingStudents / stats.totalStudents) * 100).toFixed(1),
    },
    {
