  ...
  const stats = dashboardData ? [
    {
      ...
      description: dashboardData.financial.totalOutstanding > 0 ? 'Payment due this term' : 'All fees paid',
    ...
    },
    {
      ...
      description: dashboardData.academic.currentAverage >= 75 ? 'Excellent performance' : 'Needs improvement',
    ...
    },
    {
      ...
      description: dashboardData.academic.attendanceRate >= 90 ? 'Excellent attendance' : 'Good attendance',
      icon: CalendarIcon,
    ...
    },
    {
      ...
      description: `${dashboardData.academic.totalAssignments - dashboardData.academic.completedAssignments} pending assignments`,
