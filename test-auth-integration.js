...
async function testAuthenticationFlow() {
  console.log(
    '🧪 Testing Ledgrio School Accounting System Authentication Integration\n'
  )
  ...
  try {
    ...
    if (loginResponse.data.success) {
      ...
      console.log(
        `   Refresh token: ${
          loginResponse.data.data.refreshToken ? 'Yes' : 'No'
        }\n`
      )
      ...
      try {
        ...
        if (refreshResponse.data.success) {
          ...
          console.log(
            `   New token received: ${
              refreshResponse.data.data.token ? 'Yes' : 'No'
            }\n`
          )
        } else {
      ...
      try {
        ...
        console.log(
          '❌ Logout error:',
          logoutError.response?.data?.message || logoutError.message
        )
      }
    } else {
