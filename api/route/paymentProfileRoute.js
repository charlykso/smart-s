...
router
  ...
  .get(
    authenticateToken,
    verifyRoles(roleList.Admin, roleList.Auditor, roleList.Principal),
...
router
  ...
  .get(
    ...
    paymentProfileController.getAllPaymentProfilesForSchool
  )
router
  .route('/create')
  .post(
    authenticateToken,
    verifyRoles(roleList.Admin, roleList.Auditor, roleList.Bursar),
...
router
  ...
  .delete(
    authenticateToken,
    verifyRoles(roleList.Admin, roleList.Auditor),
